...
var $author$project$BoardIsland$ReceiveBoardSnapshot = function (a) {
	return {$: 'ReceiveBoardSnapshot', a: a};
};
var $author$project$BoardIsland$emptyModel = function (_v0) {
	return {board: $elm$core$Maybe$Nothing, boardCode: '', error: $elm$core$Maybe$Nothing, flipVertical: false, ownSeat: $elm$core$Maybe$Nothing, replayIndex: $elm$core$Maybe$Nothing, version: 0};
};
var $author$project$BoardIsland$boardMoveClicked = _Platform_outgoingPort('boardMoveClicked', $elm$core$Basics$identity);
...
var $author$project$Board$Decode$boardDecoder = A2(
	...
	A9(
		...
		A2(
			...
			'waitingList',
			$elm$json$Json$Decode$list($author$project$Board$Decode$personDecoder))));
var $author$project$BoardIsland$canonicalSnapshotDecoder = A7(
	$elm$json$Json$Decode$map6,
	F6(
		function (boardCode, version, board, ownSeat, replayIndex, flipVertical) {
			return {
				board: $elm$core$Maybe$Just(board),
				boardCode: boardCode,
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'flipVertical', $elm$json$Json$Decode$bool),
				$elm$json$Json$Decode$succeed(false)
			])));
...
var $author$project$BoardIsland$publicGameSnapshotDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (boardCode) {
		return A2(
			$elm$json$Json$Decode$andThen,
			function (version) {
				return A2(
					...
					A4(
						$elm$json$Json$Decode$map3,
						F3(
							function (ownSeat, replayIndex, flipVertical) {
								return {board: $elm$core$Maybe$Nothing, boardCode: boardCode, error: $elm$core$Maybe$Nothing, flipVertical: flipVertical, ownSeat: ownSeat, replayIndex: replayIndex, version: version};
							}),
						$elm$json$Json$Decode$oneOf(
							_List_fromArray(
								[
	...
	A2($elm$json$Json$Decode$field, 'boardCode', $elm$json$Json$Decode$string));
var $author$project$BoardIsland$snapshotDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[$author$project$BoardIsland$canonicalSnapshotDecoder, $author$project$BoardIsland$publicGameSnapshotDecoder]));
var $author$project$BoardIsland$decodeSnapshot = function (value) {
	return A2($elm$json$Json$Decode$decodeValue, $author$project$BoardIsland$snapshotDecoder, value);
};
...
var $author$project$BoardIsland$update = F2(
	function (msg, model) {
		if (msg.$ === 'ReceiveBoardSnapshot') {
			var value = msg.a;
			var _v1 = $author$project$BoardIsland$decodeSnapshot(value);
			if (_v1.$ === 'Ok') {
				var nextModel = _v1.a;
			...
			var payload = $elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('boardMoveClick')),
						_Utils_Tuple2(
						'boardCode',
			...
			return _Utils_Tuple2(
				model,
				$author$project$BoardIsland$boardMoveClicked(payload));
		}
	});
var $author$project$BoardIsland$init = function (flags) {
	return A2(
		$author$project$BoardIsland$update,
		$author$project$BoardIsland$ReceiveBoardSnapshot(flags),
		$author$project$BoardIsland$emptyModel(_Utils_Tuple0));
};
var $author$project$BoardIsland$boardSnapshot = _Platform_incomingPort('boardSnapshot', $elm$json$Json$Decode$value);
var $author$project$BoardIsland$subscriptions = function (_v0) {
	return $author$project$BoardIsland$boardSnapshot($author$project$BoardIsland$ReceiveBoardSnapshot);
};
var $author$project$BoardIsland$BoardClicked = function (a) {
	return {$: 'BoardClicked', a: a};
};
...
var $author$project$BoardIsland$view = function (model) {
	var _v0 = model.error;
	if (_v0.$ === 'Just') {
		var message = _v0.a;
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Board unavailable: ' + message)
				]));
	} else {
		var _v1 = model.board;
		if (_v1.$ === 'Just') {
			var board = _v1.a;
			return A5($author$project$Board$View$viewBoard, $author$project$BoardIsland$BoardClicked, model.ownSeat, model.replayIndex, model.flipVertical, board);
		} else {
			return A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Board unavailable')
					]));
		}
	}
};
var $author$project$BoardIsland$main = $elm$browser$Browser$element(
	{init: $author$project$BoardIsland$init, subscriptions: $author$project$BoardIsland$subscriptions, update: $author$project$BoardIsland$update, view: $author$project$BoardIsland$view});
_Platform_export({'BoardIsland':{'init':$author$project$BoardIsland$main($elm$json$Json$Decode$value)(0)}});}(this));