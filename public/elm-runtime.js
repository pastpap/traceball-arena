...
var $author$project$Main$ViewportMeasured = function (a) {
	return {$: 'ViewportMeasured', a: a};
};
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $author$project$Main$Flags = F6(
	function (boardCode, clientId, playerName, savedLocalGame, savedLocalPaused, onlineMoveTimer) {
		return {boardCode: boardCode, clientId: clientId, onlineMoveTimer: onlineMoveTimer, playerName: playerName, savedLocalGame: savedLocalGame, savedLocalPaused: savedLocalPaused};
	});
...
var $author$project$Main$LocalMove = F5(
	function (playerId, from, to, segment, bounce) {
		return {bounce: bounce, from: from, playerId: playerId, segment: segment, to: to};
	});
var $elm$json$Json$Decode$map5 = _Json_map5;
var $elm$json$Json$Decode$oneOf = _Json_oneOf;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$localMoveDecoderHelper = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Main$LocalMove,
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'segment', $elm$json$Json$Decode$string),
				$elm$json$Json$Decode$succeed('')
			])),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'bounce', $elm$json$Json$Decode$bool),
...
var $author$project$Main$timerOptions = _List_fromArray(
	[0, 5, 10, 15, 20, 30]);
var $author$project$Main$normalizeMoveTimerSeconds = function (seconds) {
	return A2($elm$core$List$member, seconds, $author$project$Main$timerOptions) ? seconds : 15;
};
...
var $author$project$Main$localGameDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (base) {
		return A7(
			$elm$json$Json$Decode$map6,
			F6(
				function (scoreRed, winner, endReason, moveTimerSeconds, turnStartedAtMs, consecutiveTimeouts) {
					return _Utils_update(
						base,
						{
							consecutiveTimeouts: consecutiveTimeouts,
							endReason: endReason,
							moveTimerSeconds: $author$project$Main$normalizeMoveTimerSeconds(moveTimerSeconds),
							scoreRed: scoreRed,
							turnStartedAtMs: turnStartedAtMs,
							winner: winner
						});
				}),
			A2($elm$json$Json$Decode$field, 'scoreRed', $elm$json$Json$Decode$int),
			A2(
			...
			$elm$json$Json$Decode$oneOf(
				_List_fromArray(
					[
						A2($elm$json$Json$Decode$field, 'moveTimerSeconds', $elm$json$Json$Decode$int),
	...
	A9(
		...
		F8(
			function (blueName_, redName_, turn, ball, visited, segments, moves, scoreBlue) {
				return {ball: ball, blueName: blueName_, consecutiveTimeouts: 0, endReason: $elm$core$Maybe$Nothing, moveTimerSeconds: 15, moves: moves, redName: redName_, scoreBlue: scoreBlue, scoreRed: 0, segments: segments, turn: turn, turnStartedAtMs: $elm$core$Maybe$Nothing, visited: visited, winner: $elm$core$Maybe$Nothing};
			}),
		A2($elm$json$Json$Decode$field, 'blueName', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'redName', $elm$json$Json$Decode$string),
		...
		A2($elm$json$Json$Decode$field, 'scoreBlue', $elm$json$Json$Decode$int)));
...
var $author$project$Main$flagsDecoder = A7(
	...
	$elm$json$Json$Decode$maybe(
		A2($elm$json$Json$Decode$field, 'savedLocalGame', $author$project$Main$localGameDecoder)),
	A2(
		$elm$json$Json$Decode$map,
		$elm$core$Maybe$withDefault(false),
		$elm$json$Json$Decode$maybe(
			A2($elm$json$Json$Decode$field, 'savedLocalPaused', $elm$json$Json$Decode$bool))),
	A2(
		$elm$json$Json$Decode$map,
		$elm$core$Maybe$withDefault(15),
		$elm$json$Json$Decode$maybe(
			A2($elm$json$Json$Decode$field, 'onlineMoveTimer', $elm$json$Json$Decode$int))));
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$Main$isValidBoardCode = function (code) {
...
var $author$project$Main$sanitizeBoardCode = function (raw) {
	return A2(
		...
		if (_v0.$ === 'Ok') {
			...
			return _Utils_update(
				model,
				{
					...
					playerName: $author$project$Main$sanitizePlayerName(parsed.playerName),
					showLobby: !shouldOpenGameImmediately
				});
		} else {
...
var $author$project$Main$outgoingClientCommand = _Platform_outgoingPort('outgoingClientCommand', $elm$core$Basics$identity);
var $elm$json$Json$Encode$string = _Json_wrap;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$watchBoardCommand = F2(
	function (boardCode, clientId) {
		return $author$project$Main$isValidBoardCode(boardCode) ? $author$project$Main$outgoingClientCommand(
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('watch')),
						_Utils_Tuple2(
						'roomId',
						$elm$json$Json$Encode$string(boardCode)),
						_Utils_Tuple2(
						'clientId',
...
var $author$project$Main$init = function (flags) {
	...
	var initialCommands = A2(
		$elm$core$List$cons,
		A2($elm$core$Task$perform, $author$project$Main$ViewportMeasured, $elm$browser$Browser$Dom$getViewport),
		A2(
			$elm$core$List$cons,
					...
					$elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'type',
								$elm$json$Json$Encode$string('fetchBoardList'))
							]))),
				$author$project$Main$isValidBoardCode(model.boardCode) ? _List_fromArray(
					[
						A2($author$project$Main$watchBoardCommand, model.boardCode, model.clientId)
					]) : _List_Nil)));
	return _Utils_Tuple2(
		$author$project$Main$isValidBoardCode(model.boardCode) ? _Utils_update(
			model,
			{connectionStatus: 'connecting', showLobby: false}) : model,
		$elm$core$Platform$Cmd$batch(initialCommands));
};
var $author$project$Main$ClientNotice = function (a) {
	return {$: 'ClientNotice', a: a};
};
var $author$project$Main$ConnectionChanged = function (a) {
	return {$: 'ConnectionChanged', a: a};
};
var $author$project$Main$ReceiveBoardCreated = function (a) {
	return {$: 'ReceiveBoardCreated', a: a};
};
...
var $author$project$Main$ViewportResized = F2(
	function (a, b) {
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$incomingSocketMessage($author$project$Main$ReceiveSocket),
				$author$project$Main$incomingConnectionStatus($author$project$Main$ConnectionChanged),
...
var $author$project$Board$Types$Occupied = {$: 'Occupied'};
var $author$project$Board$Types$SessionActive = {$: 'SessionActive'};
...
var $author$project$Main$isLocalBlockedCornerCut = F2(
	function (from, to) {
		var touchesTopOutside = ((from.y === 1) && (!to.y)) || ((!from.y) && (to.y === 1));
		var touchesBottomOutside = ((from.y === 11) && (to.y === 12)) || ((from.y === 12) && (to.y === 11));
		var outsideGateMouth = (to.x < 3) || ((to.x > 5) || ((from.x < 3) || (from.x > 5)));
		var diagonal = ($elm$core$Basics$abs(from.x - to.x) === 1) && ($elm$core$Basics$abs(from.y - to.y) === 1);
		return diagonal && ((touchesTopOutside || touchesBottomOutside) && outsideGateMouth);
	});
var $author$project$Main$isLocalBoardPoint = function (p) {
	return ((p.x < 0) || ((p.x > 8) || ((p.y < 0) || (p.y > 12)))) ? false : (((p.y >= 1) && (p.y <= 11)) ? true : ((p.x >= 3) && (p.x <= 5)));
};
var $elm$core$Basics$min = F2(
	function (x, y) {
		return (_Utils_cmp(x, y) < 0) ? x : y;
	});
var $author$project$Main$isLocalTracedMarginSegment = F2(
	function (from, to) {
		var verticalSide = _Utils_eq(from.x, to.x) && (((!from.x) || (from.x === 8)) && ((from.y >= 1) && ((from.y <= 11) && ((to.y >= 1) && (to.y <= 11)))));
		var inGateMouth = (A2($elm$core$Basics$min, from.x, to.x) >= 3) && (A2($elm$core$Basics$max, from.x, to.x) <= 5);
		var horizontalPitchEdge = _Utils_eq(from.y, to.y) && (((from.y === 1) || (from.y === 11)) && ((from.x >= 0) && ((from.x <= 8) && ((to.x >= 0) && (to.x <= 8)))));
		var dy = $elm$core$Basics$abs(from.y - to.y);
		var dx = $elm$core$Basics$abs(from.x - to.x);
		return ((dx + dy) !== 1) ? false : (verticalSide ? true : ((!horizontalPitchEdge) ? false : (!inGateMouth)));
	});
var $author$project$Main$pkLocal = function (p) {
	return $elm$core$String$fromInt(p.x) + (',' + $elm$core$String$fromInt(p.y));
};
var $author$project$Main$localSegmentKey = F2(
	function (a, b) {
		var bk = $author$project$Main$pkLocal(b);
		var ak = $author$project$Main$pkLocal(a);
		return (_Utils_cmp(ak, bk) < 0) ? (ak + ('|' + bk)) : (bk + ('|' + ak));
	});
var $author$project$Main$computeLocalLegalMoves = function (lg) {
	var hasSegment = F2(
		function (a, b) {
			return A2(
				$elm$core$List$member,
				A2($author$project$Main$localSegmentKey, a, b),
				lg.segments);
		});
	var from = lg.ball;
	var deltas = _List_fromArray(
		[
			_Utils_Tuple2(-1, -1),
			_Utils_Tuple2(0, -1),
			_Utils_Tuple2(1, -1),
	...
	return A2(
		...
		function (to) {
			return !A2($author$project$Main$isLocalBlockedCornerCut, from, to);
		},
		A2(
			$elm$core$List$filter,
			function (to) {
				return !A2($author$project$Main$isLocalTracedMarginSegment, from, to);
			},
			A2(
				$elm$core$List$filter,
				function (to) {
					return !A2(hasSegment, from, to);
				},
...
var $author$project$Main$localTurnDeadlineAt = function (lg) {
	return ((lg.moveTimerSeconds <= 0) || (!_Utils_eq(lg.winner, $elm$core$Maybe$Nothing))) ? $elm$core$Maybe$Nothing : A2(
		...
		function (startedAtMs) {
			return startedAtMs + (lg.moveTimerSeconds * 1000);
		},
		lg.turnStartedAtMs);
};
var $author$project$Main$localGameToBoard = function (lg) {
	var toP = function (p) {
		return {x: p.x, y: p.y};
	};
	var toM = function (m) {
	...
	var mkSeat = F2(
		function (color_, name) {
			return {
				canBeFreed: false,
				canBeFreedAt: $elm$core$Maybe$Nothing,
				color: color_,
				disconnectedAt: $elm$core$Maybe$Nothing,
				player: $elm$core$Maybe$Just(
					{displayName: name, joinedAt: $elm$core$Maybe$Nothing}),
				state: $author$project$Board$Types$Occupied
			};
		});
	var legalMoves = $author$project$Main$computeLocalLegalMoves(lg);
	var round = {
		ball: toP(lg.ball),
		deadlineAt: $author$project$Main$localTurnDeadlineAt(lg),
		endReason: lg.endReason,
		legalMoves: A2($elm$core$List$map, toP, legalMoves),
		moves: A2($elm$core$List$map, toM, lg.moves),
		segments: lg.segments,
		state: (!_Utils_eq(lg.winner, $elm$core$Maybe$Nothing)) ? 'BetweenRounds' : 'Active',
		turn: lg.turn,
		visited: lg.visited,
		winner: lg.winner
	};
	var session = {
		...
		moveTimeLimitSeconds: $elm$core$Maybe$Just(lg.moveTimerSeconds),
		round: $elm$core$Maybe$Just(round),
		score: {blue: lg.scoreBlue, red: lg.scoreRed},
		state: (!_Utils_eq(lg.winner, $elm$core$Maybe$Nothing)) ? $author$project$Board$Types$BetweenRoundSession : $author$project$Board$Types$Active,
		turn: $elm$core$Maybe$Just(lg.turn),
		winner: lg.winner
	};
	return {
		blue: A2(mkSeat, 'blue', lg.blueName),
		code: 'LOCAL',
		createdAt: 0,
		currentSession: $elm$core$Maybe$Just(session),
		expiresAt: 0,
		red: A2(mkSeat, 'red', lg.redName),
		state: (!_Utils_eq(lg.winner, $elm$core$Maybe$Nothing)) ? $author$project$Board$Types$BetweenRounds : $author$project$Board$Types$SessionActive,
		updatedAt: 0,
		version: $elm$core$List$length(lg.moves),
		waitingList: _List_Nil,
		watchers: _List_Nil
	};
};
var $author$project$Main$winnerKeyForBoard = function (board) {
	...
	return A2(
		$elm$core$Maybe$map,
		function (winnerId) {
			return board.code + (':' + (winnerId + (':' + ($elm$core$String$fromInt(board.version) + (':' + ($elm$core$String$fromInt(
				A2(
					...
					A2(
						...
						session))) + (':' + $elm$core$String$fromInt(
				A2(
					$elm$core$Maybe$withDefault,
					0,
					A2(
...
var $author$project$Main$currentWinnerKey = function (model) {
	var _v0 = $author$project$Main$activeBoard(model);
	if (_v0.$ === 'Just') {
		var board = _v0.a;
		return $author$project$Main$winnerKeyForBoard(board);
	} else {
		return A2(
			$elm$core$Maybe$andThen,
			$author$project$Main$winnerKeyForBoard,
			A2(
				$elm$core$Maybe$map,
				$author$project$Main$localGameToBoard,
				$author$project$Main$activeLocalGame(model)));
	}
};
var $author$project$Main$normalizeSeatId = function (seatId) {
	return (seatId === 'p1') ? 'blue' : ((seatId === 'p2') ? 'red' : seatId);
};
var $author$project$Main$seatIsVacant = function (seat) {
	var _v0 = seat.state;
	if (_v0.$ === 'Vacant') {
		return true;
	} else {
...
var $author$project$Main$retainJoinedSeat = F2(
	function (joinedSeat, board) {
		var _v0 = A2($elm$core$Maybe$map, $author$project$Main$normalizeSeatId, joinedSeat);
		_v0$2:
		while (true) {
			if (_v0.$ === 'Just') {
				switch (_v0.a) {
					case 'blue':
						return $author$project$Main$seatIsVacant(board.blue) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just('blue');
					case 'red':
						return $author$project$Main$seatIsVacant(board.red) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just('red');
					default:
						break _v0$2;
				}
			} else {
...
var $author$project$Main$isLocalBoundaryPoint = function (p) {
	return (!p.x) || ((p.x === 8) || ((p.y === 1) || (p.y === 11)));
};
var $author$project$Main$restartLocalTurnClock = F2(
	function (nowMs, lg) {
		return _Utils_update(
			lg,
			{
				turnStartedAtMs: (lg.moveTimerSeconds > 0) ? $elm$core$Maybe$Just(nowMs) : $elm$core$Maybe$Nothing
			});
	});
var $author$project$Main$applyLocalMove = F3(
	function (nowMs, lg, to) {
		var _v0 = lg.winner;
		if (_v0.$ === 'Just') {
			return $elm$core$Result$Err('Round is over — start a new round.');
		} else {
			var toKey = $author$project$Main$pkLocal(to);
			var legalMoves = $author$project$Main$computeLocalLegalMoves(lg);
			var isLegal = A2(
				$elm$core$List$any,
				function (p) {
					return _Utils_eq(
						$author$project$Main$pkLocal(p),
						toKey);
				},
				legalMoves);
			if (!isLegal) {
				return $elm$core$Result$Err('Not a legal move from here.');
			} else {
				var visitedBefore = A2($elm$core$List$member, toKey, lg.visited);
				var ownGoal = ((lg.turn === 'p1') && (to.y === 12)) || ((lg.turn === 'p2') && (!to.y));
				var opponentGoal = ((lg.turn === 'p1') && (!to.y)) || ((lg.turn === 'p2') && (to.y === 12));
				var nextVisited = visitedBefore ? lg.visited : _Utils_ap(
					lg.visited,
					_List_fromArray(
						[toKey]));
				var goalWinner = opponentGoal ? $elm$core$Maybe$Just(lg.turn) : (ownGoal ? $elm$core$Maybe$Just(
					(lg.turn === 'p1') ? 'p2' : 'p1') : $elm$core$Maybe$Nothing);
				var from = lg.ball;
				var seg = A2($author$project$Main$localSegmentKey, from, to);
				var bounce = visitedBefore || $author$project$Main$isLocalBoundaryPoint(to);
				var nextMoves = _Utils_ap(
					lg.moves,
					_List_fromArray(
						[
							{bounce: bounce, from: from, playerId: lg.turn, segment: seg, to: to}
						]));
				var nextTurn = bounce ? lg.turn : ((lg.turn === 'p1') ? 'p2' : 'p1');
				...
				var stuckWinner = (_Utils_eq(goalWinner, $elm$core$Maybe$Nothing) && $elm$core$List$isEmpty(
					$author$project$Main$computeLocalLegalMoves(moved))) ? $elm$core$Maybe$Just(
					(nextTurn === 'p1') ? 'p2' : 'p1') : $elm$core$Maybe$Nothing;
				var winner = function () {
					if (goalWinner.$ === 'Just') {
						var w = goalWinner.a;
					...
					function () {
						if (winner.$ === 'Just') {
							...
							return _Utils_update(
								moved,
								{
									endReason: $elm$core$Maybe$Just('Round complete'),
									scoreBlue: (w === 'p1') ? (moved.scoreBlue + 1) : moved.scoreBlue,
									scoreRed: (w === 'p2') ? (moved.scoreRed + 1) : moved.scoreRed,
									turnStartedAtMs: $elm$core$Maybe$Nothing,
									winner: $elm$core$Maybe$Just(w)
								});
						} else {
							return A2($author$project$Main$restartLocalTurnClock, nowMs, moved);
						}
					}());
			}
		}
	});
var $author$project$Main$applyToastTick = F2(
	function (nowMs, model) {
		var _v0 = _Utils_Tuple2(model.toast, model.toastExpiresAtMs);
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
			var expiresAtMs = _v0.b.a;
			return (_Utils_cmp(nowMs, expiresAtMs) > -1) ? _Utils_update(
				model,
				{toast: $elm$core$Maybe$Nothing, toastExpiresAtMs: $elm$core$Maybe$Nothing}) : model;
		} else {
			return model;
		}
	});
var $author$project$Protocol$boardNotFoundCode = F2(
	function (payload, fallback) {
		var _v0 = payload.boardCode;
		if (_v0.$ === 'Just') {
			var boardCode = _v0.a;
			return boardCode;
		} else {
...
var $author$project$Main$boardSummaryDecoder = A7(
	...
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$field, 'isOwner', $elm$json$Json$Decode$bool),
				$elm$json$Json$Decode$succeed(false)
			])));
...
var $author$project$Main$expireLocalTurnIfNeeded = F2(
	function (nowMs, lg) {
		return A2(
			$elm$core$Maybe$andThen,
			function (deadlineAt) {
				if (_Utils_cmp(nowMs, deadlineAt) < 0) {
					return $elm$core$Maybe$Nothing;
				} else {
					if (lg.consecutiveTimeouts >= 1) {
						return $elm$core$Maybe$Just(
							_Utils_update(
								lg,
								{consecutiveTimeouts: 0, turnStartedAtMs: $elm$core$Maybe$Nothing}));
					} else {
						var timedOutPlayer = lg.turn;
						var nextTurn = (lg.turn === 'p1') ? 'p2' : 'p1';
						var switched = A2(
							$author$project$Main$restartLocalTurnClock,
							nowMs,
							_Utils_update(
								lg,
								{consecutiveTimeouts: 1, turn: nextTurn}));
						var winner = $elm$core$List$isEmpty(
							$author$project$Main$computeLocalLegalMoves(switched)) ? $elm$core$Maybe$Just(timedOutPlayer) : $elm$core$Maybe$Nothing;
						return $elm$core$Maybe$Just(
							function () {
								if (winner.$ === 'Just') {
									...
									return _Utils_update(
										...
										{
											endReason: $elm$core$Maybe$Just('Round complete'),
											scoreBlue: (winnerId === 'p1') ? (switched.scoreBlue + 1) : switched.scoreBlue,
											scoreRed: (winnerId === 'p2') ? (switched.scoreRed + 1) : switched.scoreRed,
											turnStartedAtMs: $elm$core$Maybe$Nothing,
											winner: $elm$core$Maybe$Just(winnerId)
										});
								} else {
									return switched;
								}
...
var $author$project$Main$localMoveEncoder = function (m) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'playerId',
				$elm$json$Json$Encode$string(m.playerId)),
				_Utils_Tuple2(
				'from',
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'x',
							$elm$json$Json$Encode$int(m.from.x)),
							_Utils_Tuple2(
							'y',
							$elm$json$Json$Encode$int(m.from.y))
						]))),
				_Utils_Tuple2(
				'to',
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'x',
							$elm$json$Json$Encode$int(m.to.x)),
							_Utils_Tuple2(
							'y',
							$elm$json$Json$Encode$int(m.to.y))
						]))),
				_Utils_Tuple2(
				'segment',
				$elm$json$Json$Encode$string(m.segment)),
				_Utils_Tuple2(
				'bounce',
				$elm$json$Json$Encode$bool(m.bounce))
			]));
};
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$Main$localGameEncoder = function (g) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'blueName',
				$elm$json$Json$Encode$string(g.blueName)),
				_Utils_Tuple2(
				'redName',
				$elm$json$Json$Encode$string(g.redName)),
				_Utils_Tuple2(
				'turn',
				$elm$json$Json$Encode$string(g.turn)),
				_Utils_Tuple2(
				'ball',
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'x',
							$elm$json$Json$Encode$int(g.ball.x)),
							_Utils_Tuple2(
							'y',
							$elm$json$Json$Encode$int(g.ball.y))
						]))),
				_Utils_Tuple2(
				'visited',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, g.visited)),
				_Utils_Tuple2(
				'segments',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, g.segments)),
				_Utils_Tuple2(
				'moves',
				A2($elm$json$Json$Encode$list, $author$project$Main$localMoveEncoder, g.moves)),
				_Utils_Tuple2(
				'scoreBlue',
				$elm$json$Json$Encode$int(g.scoreBlue)),
				_Utils_Tuple2(
				'scoreRed',
				$elm$json$Json$Encode$int(g.scoreRed)),
				_Utils_Tuple2(
				'winner',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, g.winner))),
				_Utils_Tuple2(
				'endReason',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, g.endReason))),
				_Utils_Tuple2(
				'moveTimerSeconds',
				$elm$json$Json$Encode$int(g.moveTimerSeconds)),
				_Utils_Tuple2(
				'turnStartedAtMs',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$int, g.turnStartedAtMs))),
				_Utils_Tuple2(
				'consecutiveTimeouts',
				$elm$json$Json$Encode$int(g.consecutiveTimeouts))
			]));
};
var $author$project$Main$persistLocalCmd = F2(
	function (localGame, paused) {
		return $author$project$Main$outgoingClientCommand(
			$elm$json$Json$Encode$object(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'type',
						$elm$json$Json$Encode$string('persistLocalRuntime')),
						_Utils_Tuple2(
						'localGame',
						function () {
							if (localGame.$ === 'Just') {
								var g = localGame.a;
								return $author$project$Main$localGameEncoder(g);
							} else {
						...
						_Utils_Tuple2(
						'localPaused',
						$elm$json$Json$Encode$bool(paused))
					])));
	});
...
var $author$project$Main$restartLocalRound = F2(
	function (nowMs, lg) {
		return _Utils_update(
			lg,
			{
				ball: {x: 4, y: 6},
				consecutiveTimeouts: 0,
				endReason: $elm$core$Maybe$Nothing,
				moves: _List_Nil,
				segments: _List_Nil,
				turn: 'p1',
				turnStartedAtMs: (lg.moveTimerSeconds > 0) ? $elm$core$Maybe$Just(nowMs) : $elm$core$Maybe$Nothing,
				visited: _List_fromArray(
					['4,6']),
				winner: $elm$core$Maybe$Nothing
			});
	});
var $elm$core$Basics$round = _Basics_round;
var $author$project$Protocol$BoardNotFound = function (a) {
	return {$: 'BoardNotFound', a: a};
};
var $author$project$Protocol$Joined = function (a) {
	return {$: 'Joined', a: a};
};
var $author$project$Protocol$Left = {$: 'Left'};
var $author$project$Protocol$SeatFreed = {$: 'SeatFreed'};
var $author$project$Protocol$ServerError = function (a) {
	return {$: 'ServerError', a: a};
};
var $author$project$Protocol$State = function (a) {
	return {$: 'State', a: a};
};
var $author$project$Protocol$UnsupportedMessage = function (a) {
	return {$: 'UnsupportedMessage', a: a};
};
var $author$project$Protocol$WaitingListJoined = {$: 'WaitingListJoined'};
var $author$project$Protocol$WaitingListLeft = {$: 'WaitingListLeft'};
var $author$project$Protocol$BoardNotFoundPayload = F2(
	function (boardCode, message) {
		return {boardCode: boardCode, message: message};
	});
var $author$project$Protocol$boardNotFoundDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Protocol$BoardNotFoundPayload,
	$elm$json$Json$Decode$maybe(
		A2($elm$json$Json$Decode$field, 'boardCode', $elm$json$Json$Decode$string)),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				...
				$elm$json$Json$Decode$succeed('Board not found or expired.')
			])));
var $author$project$Board$Decode$boardPartial = function (code) {
				...
				return function (red) {
					return function (currentSession) {
						return function (watchers) {
							return function (waitingList) {
								return function (createdAt) {
									return function (updatedAt) {
										return function (expiresAt) {
											return {blue: blue, code: code, createdAt: createdAt, currentSession: currentSession, expiresAt: expiresAt, red: red, state: state, updatedAt: updatedAt, version: version, waitingList: waitingList, watchers: watchers};
										};
									};
								};
							};
...
var $author$project$Board$Types$BoardExpired = {$: 'BoardExpired'};
var $author$project$Board$Types$OneSeatOccupied = {$: 'OneSeatOccupied'};
var $author$project$Board$Types$SessionEnded = {$: 'SessionEnded'};
var $author$project$Board$Types$SessionPaused = {$: 'SessionPaused'};
var $author$project$Board$Types$UnknownBoardState = function (a) {
	return {$: 'UnknownBoardState', a: a};
};
var $author$project$Board$Types$WaitingForPlayers = {$: 'WaitingForPlayers'};
var $author$project$Board$Decode$boardStateDecoder = A2(
	$elm$json$Json$Decode$map,
	function (value) {
		switch (value) {
			case 'WaitingForPlayers':
				return $author$project$Board$Types$WaitingForPlayers;
			case 'OneSeatOccupied':
				return $author$project$Board$Types$OneSeatOccupied;
			case 'SessionActive':
			...
			case 'SessionEnded':
				return $author$project$Board$Types$SessionEnded;
			case 'BoardExpired':
				return $author$project$Board$Types$BoardExpired;
			default:
				var other = value;
				return $author$project$Board$Types$UnknownBoardState(other);
		}
	},
	$elm$json$Json$Decode$string);
var $elm$json$Json$Decode$map3 = _Json_map3;
var $author$project$Board$Types$Person = F2(
	function (displayName, joinedAt) {
		return {displayName: displayName, joinedAt: joinedAt};
	});
...
var $author$project$Board$Types$DisconnectedReserved = {$: 'DisconnectedReserved'};
var $author$project$Board$Types$UnknownSeatState = function (a) {
	return {$: 'UnknownSeatState', a: a};
};
var $author$project$Board$Types$Vacant = {$: 'Vacant'};
var $author$project$Board$Decode$seatStateDecoder = A2(
	$elm$json$Json$Decode$map,
	function (value) {
		switch (value) {
			case 'Vacant':
	...
	$elm$json$Json$Decode$string);
var $author$project$Board$Decode$seatDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Board$Types$Seat,
	A2($elm$json$Json$Decode$field, 'color', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'state', $author$project$Board$Decode$seatStateDecoder),
	A2(
		$elm$json$Json$Decode$field,
		'player',
		$elm$json$Json$Decode$nullable($author$project$Board$Decode$personDecoder)),
	A2(
		$elm$json$Json$Decode$field,
		'disconnectedAt',
		$elm$json$Json$Decode$nullable($elm$json$Json$Decode$int)),
...
var $author$project$Board$Types$Move = F5(
	function (from, to, playerId, segment, bounce) {
		return {bounce: bounce, from: from, playerId: playerId, segment: segment, to: to};
	});
var $author$project$Board$Types$Point = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var $author$project$Board$Decode$pointDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Board$Types$Point,
	A2($elm$json$Json$Decode$field, 'x', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'y', $elm$json$Json$Decode$int));
var $author$project$Board$Decode$moveDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Board$Types$Move,
	A2($elm$json$Json$Decode$field, 'from', $author$project$Board$Decode$pointDecoder),
	A2($elm$json$Json$Decode$field, 'to', $author$project$Board$Decode$pointDecoder),
	A2($elm$json$Json$Decode$field, 'playerId', $elm$json$Json$Decode$string),
	$elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
...
var $author$project$Board$Decode$roundDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (r) {
		return A3(
			$elm$json$Json$Decode$map2,
			F2(
				function (deadlineAt, endReason) {
					return _Utils_update(
						r,
						{deadlineAt: deadlineAt, endReason: endReason});
				}),
			$elm$json$Json$Decode$maybe(
				A2($elm$json$Json$Decode$field, 'deadlineAt', $elm$json$Json$Decode$int)),
			$elm$json$Json$Decode$oneOf(
				_List_fromArray(
					[
						A2(
	...
	A9(
		$elm$json$Json$Decode$map8,
		F8(
			function (state, turn, ball, visited, segments, moves, legalMoves, winner) {
				return {ball: ball, deadlineAt: $elm$core$Maybe$Nothing, endReason: $elm$core$Maybe$Nothing, legalMoves: legalMoves, moves: moves, segments: segments, state: state, turn: turn, visited: visited, winner: winner};
			}),
		A2($elm$json$Json$Decode$field, 'state', $elm$json$Json$Decode$string),
		A2($elm$json$Json$Decode$field, 'turn', $elm$json$Json$Decode$string),
		...
		A2(
			...
			'winner',
			$elm$json$Json$Decode$nullable($elm$json$Json$Decode$string))));
var $author$project$Board$Types$Score = F2(
	function (blue, red) {
		return {blue: blue, red: red};
	});
var $author$project$Board$Decode$scoreDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Board$Types$Score,
	A2($elm$json$Json$Decode$field, 'blue', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'red', $elm$json$Json$Decode$int));
var $author$project$Board$Decode$sessionEndReasonDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$field,
...
var $author$project$Board$Decode$sessionIdDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$field,
...
var $author$project$Board$Decode$sessionMoveCountDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$map,
...
var $author$project$Board$Types$Ended = {$: 'Ended'};
var $author$project$Board$Types$Paused = {$: 'Paused'};
var $author$project$Board$Types$UnknownSessionState = function (a) {
	return {$: 'UnknownSessionState', a: a};
};
var $author$project$Board$Decode$sessionStateDecoder = A2(
	$elm$json$Json$Decode$map,
	function (value) {
		switch (value) {
			case 'Active':
			...
			case 'Ended':
				return $author$project$Board$Types$Ended;
			default:
				var other = value;
	...
	$elm$json$Json$Decode$string);
var $author$project$Board$Decode$sessionTurnDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$field,
...
var $author$project$Board$Decode$sessionWinnerDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$json$Json$Decode$field,
...
var $author$project$Board$Decode$sessionDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (base) {
		return A2(
			$elm$json$Json$Decode$map,
			function (secs) {
				return _Utils_update(
					base,
					{moveTimeLimitSeconds: secs});
			},
			$elm$json$Json$Decode$maybe(
				A2($elm$json$Json$Decode$field, 'moveTimeLimitSeconds', $elm$json$Json$Decode$int)));
	},
	A9(
		$elm$json$Json$Decode$map8,
		F8(
			function (id_, state_, score_, turn_, winner_, endReason_, moveCount_, round_) {
				return {endReason: endReason_, id: id_, moveCount: moveCount_, moveTimeLimitSeconds: $elm$core$Maybe$Nothing, round: round_, score: score_, state: state_, turn: turn_, winner: winner_};
			}),
		$author$project$Board$Decode$sessionIdDecoder,
		A2($elm$json$Json$Decode$field, 'state', $author$project$Board$Decode$sessionStateDecoder),
		A2($elm$json$Json$Decode$field, 'score', $author$project$Board$Decode$scoreDecoder),
		$author$project$Board$Decode$sessionTurnDecoder,
		$author$project$Board$Decode$sessionWinnerDecoder,
		$author$project$Board$Decode$sessionEndReasonDecoder,
		$author$project$Board$Decode$sessionMoveCountDecoder,
		$elm$json$Json$Decode$maybe(
			A2($elm$json$Json$Decode$field, 'round', $author$project$Board$Decode$roundDecoder))));
var $author$project$Board$Decode$boardDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (finish) {
		return A4(
	...
	A9(
		$elm$json$Json$Decode$map8,
		$author$project$Board$Decode$boardPartial,
		...
		A2($elm$json$Json$Decode$field, 'state', $author$project$Board$Decode$boardStateDecoder),
		A2(
			$elm$json$Json$Decode$at,
			_List_fromArray(
				['seats', 'blue']),
			$author$project$Board$Decode$seatDecoder),
		A2(
			$elm$json$Json$Decode$at,
			_List_fromArray(
				['seats', 'red']),
		...
		A2(
			$elm$json$Json$Decode$field,
			'currentSession',
			$elm$json$Json$Decode$nullable($author$project$Board$Decode$sessionDecoder)),
		A2(
			$elm$json$Json$Decode$field,
			'watchers',
...
var $author$project$Protocol$decodeByType = function (messageType) {
	switch (messageType) {
		case 'state':
			return A2($elm$json$Json$Decode$map, $author$project$Protocol$State, $author$project$Protocol$stateMessageDecoder);
		case 'BoardNotFound':
			return A2($elm$json$Json$Decode$map, $author$project$Protocol$BoardNotFound, $author$project$Protocol$boardNotFoundDecoder);
		case 'joined':
			return A2(
				$elm$json$Json$Decode$map,
				$author$project$Protocol$Joined,
				$elm$json$Json$Decode$maybe(
					A2($elm$json$Json$Decode$field, 'playerId', $elm$json$Json$Decode$string)));
		case 'left':
			return $elm$json$Json$Decode$succeed($author$project$Protocol$Left);
		case 'waitingListJoined':
			return $elm$json$Json$Decode$succeed($author$project$Protocol$WaitingListJoined);
		case 'waitingListLeft':
			return $elm$json$Json$Decode$succeed($author$project$Protocol$WaitingListLeft);
		case 'seatFreed':
			return $elm$json$Json$Decode$succeed($author$project$Protocol$SeatFreed);
		case 'error':
			return A2(
				$elm$json$Json$Decode$map,
				$author$project$Protocol$ServerError,
				$elm$json$Json$Decode$oneOf(
					_List_fromArray(
						[
							A2($elm$json$Json$Decode$field, 'error', $elm$json$Json$Decode$string),
							$elm$json$Json$Decode$succeed('Server error.')
						])));
		default:
			return $elm$json$Json$Decode$succeed(
				$author$project$Protocol$UnsupportedMessage('unsupported message type: ' + messageType));
	}
};
var $author$project$Protocol$serverMessageDecoder = A2(
	$elm$json$Json$Decode$andThen,
	$author$project$Protocol$decodeByType,
	A2($elm$json$Json$Decode$field, 'type', $elm$json$Json$Decode$string));
var $author$project$Main$startLocalGame = F4(
	function (nowMs, blueName_, redName_, moveTimerSeconds) {
		return {
			ball: {x: 4, y: 6},
			blueName: $elm$core$String$isEmpty(
				$elm$core$String$trim(blueName_)) ? 'Blue' : $elm$core$String$trim(blueName_),
			consecutiveTimeouts: 0,
			endReason: $elm$core$Maybe$Nothing,
			moveTimerSeconds: $author$project$Main$normalizeMoveTimerSeconds(moveTimerSeconds),
			moves: _List_Nil,
			redName: $elm$core$String$isEmpty(
				$elm$core$String$trim(redName_)) ? 'Red' : $elm$core$String$trim(redName_),
			scoreBlue: 0,
			scoreRed: 0,
			segments: _List_Nil,
			turn: 'p1',
			turnStartedAtMs: (moveTimerSeconds > 0) ? $elm$core$Maybe$Just(nowMs) : $elm$core$Maybe$Nothing,
			visited: _List_fromArray(
				['4,6']),
			winner: $elm$core$Maybe$Nothing
		};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ReceiveSocket':
				var value = msg.a;
				var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Protocol$serverMessageDecoder, value);
				if (_v1.$ === 'Ok') {
					var serverMessage = _v1.a;
					switch (serverMessage.$) {
						case 'State':
							var incoming = serverMessage.a;
							return _Utils_Tuple2(
								A2($author$project$Main$applyIncoming, incoming, model),
								$elm$core$Platform$Cmd$none);
						case 'BoardNotFound':
							var payload = serverMessage.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
								...
								$elm$core$Platform$Cmd$none);
						case 'Joined':
							var maybeSeatId = serverMessage.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										...
										joinedSeat: function () {
											if (maybeSeatId.$ === 'Just') {
												var seatId = maybeSeatId.a;
												return $elm$core$Maybe$Just(
													$author$project$Main$normalizeSeatId(seatId));
											} else {
												return model.joinedSeat;
											}
										}()
									}),
								$elm$core$Platform$Cmd$none);
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										error: $elm$core$Maybe$Nothing,
										joinedSeat: $elm$core$Maybe$Nothing,
										toast: $elm$core$Maybe$Just('You left the board.'),
										toastExpiresAtMs: $elm$core$Maybe$Just(model.currentTimeMs + 2200)
									}),
								$elm$core$Platform$Cmd$none);
						case 'WaitingListJoined':
							return _Utils_Tuple2(
						...
						case 'WaitingListLeft':
							return _Utils_Tuple2(
								_Utils_update(
									...
									{
										error: $elm$core$Maybe$Nothing,
										toast: $elm$core$Maybe$Just('You left the waiting list.'),
										toastExpiresAtMs: $elm$core$Maybe$Just(model.currentTimeMs + 2200)
									}),
								$elm$core$Platform$Cmd$none);
						case 'SeatFreed':
							return _Utils_Tuple2(
								_Utils_update(
									...
									{
										error: $elm$core$Maybe$Nothing,
										toast: $elm$core$Maybe$Just('Seat released.'),
										toastExpiresAtMs: $elm$core$Maybe$Just(model.currentTimeMs + 2200)
									}),
								$elm$core$Platform$Cmd$none);
						case 'ServerError':
							var message = serverMessage.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
			...
			case 'Tick':
				...
				var withToast = function (updatedModel) {
					return A2($author$project$Main$applyToastTick, nowMs, updatedModel);
				};
				var _v4 = model.localGame;
				if (_v4.$ === 'Just') {
					var lg = _v4.a;
					if (model.localPaused) {
						...
						var _v5 = A2($author$project$Main$expireLocalTurnIfNeeded, nowMs, lg);
						if (_v5.$ === 'Just') {
							var nextGame = _v5.a;
							return _Utils_Tuple2(
								withToast(
									_Utils_update(
										...
										{
											currentTimeMs: nowMs,
											localGame: $elm$core$Maybe$Just(nextGame),
											localPaused: _Utils_eq(nextGame.turnStartedAtMs, $elm$core$Maybe$Nothing) && _Utils_eq(nextGame.winner, $elm$core$Maybe$Nothing)
										})),
								A2(
									$author$project$Main$persistLocalCmd,
									$elm$core$Maybe$Just(nextGame),
									_Utils_eq(nextGame.turnStartedAtMs, $elm$core$Maybe$Nothing) && _Utils_eq(nextGame.winner, $elm$core$Maybe$Nothing)));
						} else {
							return _Utils_Tuple2(
								withToast(
									_Utils_update(
			...
			case 'ViewportMeasured':
				var viewport = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							viewportWidth: $elm$core$Basics$round(viewport.viewport.width)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ViewportResized':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{viewportWidth: width}),
					$elm$core$Platform$Cmd$none);
			case 'DismissWinnerBanner':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							dismissedWinnerKey: $author$project$Main$currentWinnerKey(model)
						}),
					$elm$core$Platform$Cmd$none);
			case 'OpenTimerSheet':
				return _Utils_Tuple2(
			...
			case 'UpdateBoardCodeInput':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							draftBoardCode: $author$project$Main$sanitizeBoardCode(raw),
							error: $elm$core$Maybe$Nothing
						}),
					$elm$core$Platform$Cmd$none);
			case 'SubmitWatchBoard':
				var boardCode = $author$project$Main$sanitizeBoardCode(model.draftBoardCode);
				return $author$project$Main$isValidBoardCode(boardCode) ? _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2($author$project$Main$watchBoardCommand, boardCode, model.clientId),
								$author$project$Main$outgoingClientCommand(
								$elm$json$Json$Encode$object(
									_List_fromArray(
										[
											...
											_Utils_Tuple2(
											'url',
											$elm$json$Json$Encode$string('/?board=' + boardCode))
										])))
							]))) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							error: $elm$core$Maybe$Just('Enter a valid board code.')
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdatePlayerName':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{error: $elm$core$Maybe$Nothing, playerName: name}),
					$author$project$Main$outgoingClientCommand(
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
						...
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'type',
									$elm$json$Json$Encode$string('deleteBoard')),
									_Utils_Tuple2(
									'roomId',
									$elm$json$Json$Encode$string(roomId))
								])))) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			case 'ClaimSeat':
				var seatId = msg.a;
				var serverSeatId = (seatId === 'blue') ? 'p1' : ((seatId === 'red') ? 'p2' : seatId);
				return _Utils_Tuple2(
					model,
					$author$project$Main$outgoingClientCommand(
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
									...
									_Utils_Tuple2(
									'seatId',
									$elm$json$Json$Encode$string(serverSeatId)),
									_Utils_Tuple2(
									'name',
									$elm$json$Json$Encode$string(model.playerName)),
									_Utils_Tuple2(
									'roomId',
									$elm$json$Json$Encode$string(model.boardCode)),
									_Utils_Tuple2(
									'clientId',
						...
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'type',
									$elm$json$Json$Encode$string('joinWaitingList')),
									_Utils_Tuple2(
									'name',
									$elm$json$Json$Encode$string(model.playerName)),
									_Utils_Tuple2(
						...
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'type',
									$elm$json$Json$Encode$string('leaveWaitingList')),
									_Utils_Tuple2(
									'roomId',
									$elm$json$Json$Encode$string(model.boardCode)),
									_Utils_Tuple2(
							...
							$elm$json$Json$Encode$object(
								_List_fromArray(
									[
										_Utils_Tuple2(
										'type',
										$elm$json$Json$Encode$string('move')),
										_Utils_Tuple2(
										'to',
										$elm$json$Json$Encode$object(
											_List_fromArray(
												[
													_Utils_Tuple2(
													'x',
													$elm$json$Json$Encode$int(point.x)),
													_Utils_Tuple2(
													'y',
													$elm$json$Json$Encode$int(point.y))
												])))
									]))));
				} else {
						...
						if (model.localPaused) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										error: $elm$core$Maybe$Just('Resume the game before moving.')
									}),
								$elm$core$Platform$Cmd$none);
						} else {
							...
							if (_v7.$ === 'Ok') {
								...
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											error: $elm$core$Maybe$Just(reason)
										}),
									$elm$core$Platform$Cmd$none);
							}
						}
			...
			case 'UpdateFreeSeatInput':
				var raw = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							draftFreeSeat: $elm$core$String$toLower(
								$elm$core$String$trim(raw)),
							error: $elm$core$Maybe$Nothing
						}),
					$elm$core$Platform$Cmd$none);
			case 'SubmitFreeSeat':
				return ((model.draftFreeSeat === 'p1') || (model.draftFreeSeat === 'p2')) ? _Utils_Tuple2(
					model,
					$author$project$Main$outgoingClientCommand(
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'type',
									$elm$json$Json$Encode$string('freeSeat')),
									_Utils_Tuple2(
									'seatId',
									$elm$json$Json$Encode$string(model.draftFreeSeat))
								])))) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							error: $elm$core$Maybe$Just('Seat must be p1 or p2.')
						}),
					$elm$core$Platform$Cmd$none);
			case 'ReplayToStart':
				return _Utils_Tuple2(
			...
			case 'ReplayStepBack':
				var currentIndex = A2(
					$elm$core$Maybe$withDefault,
					$author$project$Main$currentMoveCount(model),
					model.replayIndex);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							replayIndex: $elm$core$Maybe$Just(
								A2($elm$core$Basics$max, 0, currentIndex - 1))
						}),
					$elm$core$Platform$Cmd$none);
			case 'ReplayStepForward':
				var max_ = $author$project$Main$currentMoveCount(model);
				var next = A2($elm$core$Maybe$withDefault, max_, model.replayIndex) + 1;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							replayIndex: (_Utils_cmp(next, max_) > -1) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(next)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ReplayToLive':
				return _Utils_Tuple2(
			...
			case 'ToggleLocalPause':
				...
				if (_v9.$ === 'Just') {
					...
					var nextGame = nextPaused ? _Utils_update(
						lg,
						{turnStartedAtMs: $elm$core$Maybe$Nothing}) : A2(
						$author$project$Main$restartLocalTurnClock,
						model.currentTimeMs,
						_Utils_update(
							lg,
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							dismissedWinnerKey: $elm$core$Maybe$Nothing,
							error: $elm$core$Maybe$Nothing,
							localGame: $elm$core$Maybe$Nothing,
							localPaused: false,
							toast: $elm$core$Maybe$Just('Local game discarded.'),
							toastExpiresAtMs: $elm$core$Maybe$Just(model.currentTimeMs + 2200)
						}),
					A2($author$project$Main$persistLocalCmd, $elm$core$Maybe$Nothing, false));
			case 'UpdateLocalBlueName':
				var raw = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						...
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'type',
									$elm$json$Json$Encode$string('createBoard')),
									_Utils_Tuple2(
						...
						$elm$json$Json$Encode$object(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'type',
									$elm$json$Json$Encode$string('persistOnlineMoveTimer')),
									_Utils_Tuple2(
									'seconds',
									$elm$json$Json$Encode$int(seconds))
								]))));
			case 'SelectOnlineMoveTimer':
				var seconds = msg.a;
...
var $author$project$Main$RequestBoardList = {$: 'RequestBoardList'};
...
var $author$project$Main$DeleteBoard = function (a) {
	return {$: 'DeleteBoard', a: a};
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Border$width(1),
						$mdgriffith$elm_ui$Element$Border$color(
						A3($mdgriffith$elm_ui$Element$rgb255, 219, 80, 73)),
						$mdgriffith$elm_ui$Element$Background$color(
						A4($mdgriffith$elm_ui$Element$rgba255, 255, 59, 48, 36)),
						$mdgriffith$elm_ui$Element$Font$color(
						A3($mdgriffith$elm_ui$Element$rgb255, 255, 211, 208)),
						$mdgriffith$elm_ui$Element$Font$size(14),
						$mdgriffith$elm_ui$Element$Font$bold,
						$mdgriffith$elm_ui$Element$padding(0)
					]),
				{
					...
					onPress: $elm$core$Maybe$Just(
						$author$project$Main$DeleteBoard(board.roomId))
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$Background$color(
				A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 0.25)),
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$Font$size(14),
								$mdgriffith$elm_ui$Element$Font$color(
								A3($mdgriffith$elm_ui$Element$rgb255, 140, 200, 140))
							]),
						$mdgriffith$elm_ui$Element$text('Live boards')),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
				...
				$mdgriffith$elm_ui$Element$text('No live boards. Create one!')) : A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$Main$derivedOwnSeat = F2(
	function (model, board) {
		...
		if (_v0.$ === 'Just') {
			var seatId = _v0.a;
			return $elm$core$Maybe$Just(seatId);
		} else {
			var redName = A2(
				$elm$core$Maybe$map,
				function ($) {
...
var $author$project$Main$heroRoleClass = function (roleClass) {
	return $elm$core$String$isEmpty(roleClass) ? 'hero-board-role' : ('hero-board-role ' + roleClass);
};
...
var $author$project$Main$turnColorLabel = function (t) {
	return ((t === 'blue') || (t === 'p1')) ? 'Blue' : (((t === 'red') || (t === 'p2')) ? 'Red' : t);
};
var $elm$html$Html$Attributes$type_ = $elm$html$Html$Attributes$stringProperty('type');
var $author$project$Main$waitingStatusTextForBoard = function (board) {
	var redVacant = $author$project$Main$seatIsVacant(board.red);
	var blueVacant = $author$project$Main$seatIsVacant(board.blue);
	return (blueVacant && redVacant) ? 'Board open - choose Blue or Red.' : (blueVacant ? 'Waiting for a Blue player.' : (redVacant ? 'Waiting for a Red player.' : 'Waiting for the next session.'));
};
var $author$project$Main$viewGameHeader = function (model) {
	var heroStatus = function () {
		...
		if (_v0.$ === 'Just') {
			...
			return {
				...
				roleText: function () {
					if (ownSeat.$ === 'Just') {
						var seatId = ownSeat.a;
						return 'You are ' + $author$project$Main$turnColorLabel(seatId);
					} else {
						return 'Watching';
					}
				}(),
				turnText: $elm$core$String$isEmpty(turn) ? $author$project$Main$waitingStatusTextForBoard(board) : ('Turn: ' + $author$project$Main$turnColorLabel(turn))
			};
		} else {
			...
			if (_v2.$ === 'Just') {
				...
				return {
					boardCode: 'LOCAL',
					roleClass: $author$project$Main$normalizeSeatId(lg.turn),
					roleText: 'You are ' + $author$project$Main$turnColorLabel(lg.turn),
					turnText: model.localPaused ? 'Paused' : ((!_Utils_eq(lg.winner, $elm$core$Maybe$Nothing)) ? 'Round complete' : ('Turn: ' + $author$project$Main$turnColorLabel(lg.turn)))
				};
			} else {
				return {boardCode: '', roleClass: '', roleText: '', turnText: ''};
			}
		}
	}();
	return A2(
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$htmlAttribute(
								$elm$html$Html$Attributes$class('hero-game-status'))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$htmlAttribute(
										$elm$html$Html$Attributes$class('hero-board-code')),
										$mdgriffith$elm_ui$Element$Font$size(16),
										$mdgriffith$elm_ui$Element$Font$color(
										A3($mdgriffith$elm_ui$Element$rgb255, 247, 255, 248)),
										$mdgriffith$elm_ui$Element$Font$bold
									]),
								$mdgriffith$elm_ui$Element$text(heroStatus.boardCode)),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$htmlAttribute(
										$elm$html$Html$Attributes$class(
											$author$project$Main$heroRoleClass(heroStatus.roleClass)))
									]),
								A2(
									$mdgriffith$elm_ui$Element$row,
									_List_fromArray(
									...
									_Utils_ap(
										$elm$core$String$isEmpty(heroStatus.roleClass) ? _List_Nil : _List_fromArray(
											[
												A2(
												$mdgriffith$elm_ui$Element$el,
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$htmlAttribute(
														$elm$html$Html$Attributes$class('hero-role-dot ' + heroStatus.roleClass))
													]),
												$mdgriffith$elm_ui$Element$none)
											]),
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$mdgriffith$elm_ui$Element$Font$size(13),
														$mdgriffith$elm_ui$Element$Font$color(
														A3($mdgriffith$elm_ui$Element$rgb255, 240, 248, 244)),
														$mdgriffith$elm_ui$Element$Font$semiBold
													]),
												$mdgriffith$elm_ui$Element$text(heroStatus.roleText))
											])))),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$htmlAttribute(
										$elm$html$Html$Attributes$class('hero-turn-state')),
										$mdgriffith$elm_ui$Element$Font$size(13),
										$mdgriffith$elm_ui$Element$Font$color(
										A3($mdgriffith$elm_ui$Element$rgb255, 213, 230, 217)),
										$mdgriffith$elm_ui$Element$Font$semiBold
									]),
								$mdgriffith$elm_ui$Element$text(heroStatus.turnText))
							]))))
			]),
		A2(
			$mdgriffith$elm_ui$Element$row,
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$centerY,
							$mdgriffith$elm_ui$Element$htmlAttribute(
							$elm$html$Html$Attributes$class('hero-brand'))
						]),
					_List_fromArray(
						[
							...
							A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('hero-icon'),
							...
							$mdgriffith$elm_ui$Element$text('Traceball Arena'))
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$centerY,
							$mdgriffith$elm_ui$Element$htmlAttribute(
							$elm$html$Html$Attributes$class('hero-actions'))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$htmlAttribute(
									$elm$html$Html$Attributes$class('hero-lobby-btn')),
									$mdgriffith$elm_ui$Element$Font$size(13),
									$mdgriffith$elm_ui$Element$Font$color(
									A3($mdgriffith$elm_ui$Element$rgb255, 244, 255, 246)),
									$mdgriffith$elm_ui$Element$Font$semiBold
							...
							{
								label: $mdgriffith$elm_ui$Element$text('Lobby'),
...
var $author$project$Main$viewHeaderHtml = F2(
	function (model, hasGame) {
		var heroStatus = function () {
			var _v0 = $author$project$Main$activeBoard(model);
			if (_v0.$ === 'Just') {
				var board = _v0.a;
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Realtime paper-soccer')
								])),
							A2(
							$elm$html$Html$h1,
							_List_Nil,
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Draw one line per move, bounce from old points and walls, and sneak the ball into the other gate.')
								]))
						])),
					A2(
					$elm$html$Html$div,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(heroStatus.boardCode)
								])),
							A2(
							$elm$html$Html$span,
							_List_fromArray(
							...
							$elm$core$String$isEmpty(heroStatus.roleClass) ? _List_fromArray(
								[
									$elm$html$Html$text(heroStatus.roleText)
								]) : _List_fromArray(
								[
									A2(
									$elm$html$Html$span,
							...
							_List_fromArray(
								[
									$elm$html$Html$text(heroStatus.turnText)
								]))
						])) : $elm$html$Html$text(''),
					A2(
					$elm$html$Html$div,
...
var $author$project$Main$replayShowsWinner = F2(
	function (replayIndex, moveCount) {
		if (replayIndex.$ === 'Nothing') {
			...
			var index = replayIndex.a;
			return _Utils_cmp(index, moveCount) > -1;
		}
	});
var $author$project$Main$ClaimSeat = function (a) {
	return {$: 'ClaimSeat', a: a};
};
...
var $author$project$Board$View$allBoardPoints = _Utils_ap(
	A2(
...
var $author$project$Board$View$toSeatColor = function (s) {
	switch (s) {
		case 'p1':
			return 'blue';
		case 'p2':
...
var $author$project$Board$View$isOwnTurnCheck = F2(
	function (ownSeat, turn) {
		if (ownSeat.$ === 'Nothing') {
			...
			var s = ownSeat.a;
			return _Utils_eq(
				$author$project$Board$View$toSeatColor(s),
				$author$project$Board$View$toSeatColor(turn));
		}
	});
...
var $author$project$Board$View$viewCornerFlag = F3(
	function (gx, gy, color) {
		var dy = (gy < 6) ? (-1) : 1;
		var dx = (gx > 0) ? 1 : (-1);
		var cy_ = $author$project$Board$View$syv(gy);
		var hy = cy_ + (dy * 48);
		var cx_ = $author$project$Board$View$sxv(gx);
		var hx = cx_ + (dx * 18);
		var pl = $elm$core$Basics$sqrt(
			A2($elm$core$Basics$pow, hx - cx_, 2) + A2($elm$core$Basics$pow, hy - cy_, 2));
		var uy = (hy - cy_) / pl;
		var nx0 = -uy;
		var p1y = hy - (uy * 15);
		var p3y = hy + (uy * 15);
		...
		var p1x = hx - (ux * 15);
		var p3x = hx + (ux * 15);
		var _v0 = ((nx0 * dx) < 0) ? _Utils_Tuple2(-nx0, -ny0) : _Utils_Tuple2(nx0, ny0);
		var nx = _v0.a;
		var ny = _v0.b;
		var p2x = hx + (nx * 30);
		var p2y = hy + (ny * 30);
		var pts = $author$project$Board$View$flt(p1x) + (',' + ($author$project$Board$View$flt(p1y) + (' ' + ($author$project$Board$View$flt(p2x) + (',' + ($author$project$Board$View$flt(p2y) + (' ' + ($author$project$Board$View$flt(p3x) + (',' + $author$project$Board$View$flt(p3y))))))))));
		return A2(
			$elm$svg$Svg$g,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Board$View$flt(cx_)),
							$elm$svg$Svg$Attributes$y1(
							$author$project$Board$View$flt(cy_)),
							$elm$svg$Svg$Attributes$x2(
							$author$project$Board$View$flt(hx)),
							$elm$svg$Svg$Attributes$y2(
							$author$project$Board$View$flt(hy)),
							$elm$svg$Svg$Attributes$stroke('rgba(255,255,255,0.9)'),
					...
					_List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$fill('rgba(255,255,255,0.55)')
						]),
					_List_Nil),
					A2(
					$elm$svg$Svg$polygon,
					_List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$opacity('0.92')
						]),
					_List_Nil)
				]));
	});
var $author$project$Board$View$viewGateMesh = function (gy) {
	var y1 = $author$project$Board$View$syv(gy + 1);
	var y0 = $author$project$Board$View$syv(gy);
	var x1 = $author$project$Board$View$sxv(5);
	var x0 = $author$project$Board$View$sxv(3);
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$x1(
						$author$project$Board$View$flt(x0)),
						$elm$svg$Svg$Attributes$y1(
						$author$project$Board$View$flt(y0)),
						$elm$svg$Svg$Attributes$x2(
						$author$project$Board$View$flt(x1)),
						$elm$svg$Svg$Attributes$y2(
						$author$project$Board$View$flt(y1)),
...
var $author$project$Board$View$viewGridDot = F3(
	function (visited, ballKey, pt) {
		if (_Utils_eq(
...
var $author$project$Board$View$viewMoveSegment = function (move) {
	var color = $author$project$Board$View$playerHex(move.playerId);
	return A2(
		$elm$svg$Svg$g,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$x1(
						$author$project$Board$View$sx(move.from.x)),
						$elm$svg$Svg$Attributes$y1(
						$author$project$Board$View$sy(move.from.y)),
						$elm$svg$Svg$Attributes$x2(
...
var $author$project$Board$View$viewPostCap = F2(
	function (x, y) {
		return A2(
			$elm$svg$Svg$circle,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$cx(
					$author$project$Board$View$sx(x)),
					$elm$svg$Svg$Attributes$cy(
					$author$project$Board$View$sy(y)),
					$elm$svg$Svg$Attributes$r('6'),
					$elm$svg$Svg$Attributes$fill('rgba(255,255,255,0.9)')
				]),
			_List_Nil);
	});
var $elm$core$Basics$sin = _Basics_sin;
var $author$project$Board$View$pseudoSigned = F2(
	function (seed, index) {
		var angle = (seed * 29) + (index * 19);
		return $elm$core$Basics$sin(angle);
	});
var $author$project$Board$View$pseudoUnit = F2(
	function (seed, index) {
		var angle = (seed * 31) + (index * 17);
		return $elm$core$Basics$abs(
			$elm$core$Basics$sin(angle));
	});
var $author$project$Board$View$buildBurstPieces = function (burst) {
	return A2(
		$elm$core$List$map,
		function (index) {
			var unitY = A2($author$project$Board$View$pseudoUnit, burst.seed, (index * 5) + 1);
			var unitX = A2($author$project$Board$View$pseudoSigned, burst.seed, index * 5);
			var unitSize = A2($author$project$Board$View$pseudoUnit, burst.seed, (index * 5) + 2);
			var widthPx = 8 + $elm$core$Basics$round(unitSize * 8);
			var unitRot = A2($author$project$Board$View$pseudoSigned, burst.seed, (index * 5) + 3);
			var unitDelay = A2($author$project$Board$View$pseudoUnit, burst.seed, (index * 5) + 4);
			var rotation = $elm$core$String$fromInt(
				$elm$core$Basics$round(unitRot * 34));
			var heightPx = 7 + $elm$core$Basics$round((1 - (unitSize / 2)) * 9);
			var dyMagnitude = (56 + $elm$core$Basics$round(unitY * 86)) + (index * 8);
			var dyPx = burst.targetTop ? dyMagnitude : (-dyMagnitude);
			var dxPx = $elm$core$Basics$round(unitX * (30 + (index * 10)));
			var duration = $elm$core$String$fromInt(
				(1180 + $elm$core$Basics$round(unitY * 640)) + (index * 45)) + 'ms';
			var drift = $elm$core$String$fromInt(
				$elm$core$Basics$round(unitRot * 42)) + 'deg';
			var delay = $elm$core$String$fromInt(
				burst.delayBase + $elm$core$Basics$round(unitDelay * 150)) + 'ms';
			return {
				delay: delay,
				drift: drift,
				duration: duration,
				dx: $elm$core$String$fromInt(dxPx) + 'px',
				dy: $elm$core$String$fromInt(dyPx) + 'px',
				height: $elm$core$String$fromInt(heightPx),
				rotation: rotation,
				width: $elm$core$String$fromInt(widthPx),
				x: burst.x,
				y: burst.y
			};
		},
...
var $author$project$Board$View$viewWinnerConfetti = F2(
	function (version, winnerId) {
		var winnerColor = $author$project$Board$View$playerHex(winnerId);
		var targetTop = $author$project$Board$View$toSeatColor(winnerId) === 'red';
		var gateY = targetTop ? 150 : 760;
		var gateSeed = targetTop ? (version + 17) : (version + 43);
		var burstCenters = A2(
			$elm$core$List$map,
			function (index) {
				var unitY = A2($author$project$Board$View$pseudoUnit, gateSeed, (index * 3) + 1);
				var unitX = A2($author$project$Board$View$pseudoUnit, gateSeed, index * 3);
				return {
					delayBase: index * 500,
					seed: gateSeed + (index * 11),
					targetTop: targetTop,
					x: $elm$core$Basics$round(310 + (unitX * 110)),
					y: targetTop ? $elm$core$Basics$round((gateY - 42) + (unitY * 18)) : $elm$core$Basics$round((gateY + 42) - (unitY * 18))
				};
			},
			A2($elm$core$List$range, 0, 2));
		var pieces = A2($elm$core$List$concatMap, $author$project$Board$View$buildBurstPieces, burstCenters);
		return A2(
			$elm$svg$Svg$g,
			_List_fromArray(
				[
					$elm$svg$Svg$Attributes$class('elm-confetti')
				]),
			A2(
				...
				F2(
					function (index, piece) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$svg$Svg$Attributes$class('elm-confetti-piece'),
									$elm$svg$Svg$Attributes$x(
									$elm$core$String$fromInt(piece.x)),
									$elm$svg$Svg$Attributes$y(
									$elm$core$String$fromInt(piece.y)),
									$elm$svg$Svg$Attributes$width(piece.width),
									$elm$svg$Svg$Attributes$height(piece.height),
									$elm$svg$Svg$Attributes$rx('3'),
									$elm$svg$Svg$Attributes$fill(
									(!A2($elm$core$Basics$modBy, 2, index)) ? winnerColor : '#ffe784'),
									$elm$svg$Svg$Attributes$transform(
									'rotate(' + (piece.rotation + (' ' + ($elm$core$String$fromInt(piece.x) + (' ' + ($elm$core$String$fromInt(piece.y) + ')')))))),
									$elm$svg$Svg$Attributes$style('--elm-confetti-dx: ' + (piece.dx + (';' + ('--elm-confetti-dy: ' + (piece.dy + (';' + ('--elm-confetti-rot: ' + (piece.drift + (';' + ('animation-delay: ' + (piece.delay + (';' + ('animation-duration: ' + (piece.duration + ';'))))))))))))))
								]),
							_List_Nil);
					}),
				pieces));
...
var $author$project$Board$View$viewBoard = F5(
	function (onMove, ownSeat, replayIndex, flipVertical, board) {
		...
		var round = A2(
			...
			session);
		var turn = _Utils_eq(replayIndex, $elm$core$Maybe$Nothing) ? A2(
			$elm$core$Maybe$withDefault,
			'',
			A2(
				$elm$core$Maybe$map,
				...
				round)) : '';
		var legalMoves = _Utils_eq(replayIndex, $elm$core$Maybe$Nothing) ? A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2(
				$elm$core$Maybe$map,
		...
		var replayCount = A2(
			$elm$core$Maybe$withDefault,
			$elm$core$List$length(allMoves),
			replayIndex);
		var moves = A2($elm$core$List$take, replayCount, allMoves);
		var ball = function () {
			var _v1 = $elm$core$List$head(
				$elm$core$List$reverse(moves));
			if (_v1.$ === 'Just') {
				var lastMove = _v1.a;
				return lastMove.to;
			} else {
		...
		var visited = A2(
			...
			A2(
				...
				A2(
					...
					$author$project$Board$View$pk),
				moves));
		var replayAtEnd = _Utils_cmp(
			replayCount,
			$elm$core$List$length(allMoves)) > -1;
		var winner = (_Utils_eq(replayIndex, $elm$core$Maybe$Nothing) || replayAtEnd) ? A2(
			$elm$core$Maybe$andThen,
			function ($) {
				return $.winner;
			},
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$viewBox('0 0 720 920'),
					$elm$svg$Svg$Attributes$style('width:100%;height:auto;display:block;margin:0 auto'),
...
var $author$project$Main$viewBoardBadgeHtml = F4(
	function (position, color, name, score) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('elm-board-badge elm-board-badge-' + position)
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('dot ' + color)
						]),
					_List_Nil),
					A2(
					$elm$html$Html$span,
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('elm-board-badge-score')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('pause-card')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('pauseTurn')
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('pause-actions')
							]),
						_List_fromArray(
							[
								A2(
...
var $author$project$Main$DismissWinnerBanner = {$: 'DismissWinnerBanner'};
var $author$project$Main$viewWinnerOverlayHtml = F3(
	function (isCompactLayout, winnerName, onNewRound) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('winner-overlay', true),
							_Utils_Tuple2('winner-overlay-mobile', isCompactLayout)
						])),
					A2($elm$html$Html$Attributes$attribute, 'aria-live', 'polite')
				]),
			_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											_Utils_Tuple2('winner-close', true),
											_Utils_Tuple2(
											'hidden',
											_Utils_eq(onNewRound, $elm$core$Maybe$Nothing) && (!isCompactLayout))
										])),
									A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Close winner banner'),
									$elm$html$Html$Events$onClick($author$project$Main$DismissWinnerBanner)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('×')
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('winner-kicker')
								]),
							_List_fromArray(
								[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('winner-name')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(winnerName)
								])),
							isCompactLayout ? $elm$html$Html$text('') : A2(
							$elm$html$Html$button,
							_Utils_ap(
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('button'),
										$elm$html$Html$Attributes$class('winner-new-round')
									]),
								$author$project$Main$onClickAttributes(onNewRound)),
							_List_fromArray(
								[
				...
				_Utils_ap(
					function () {
						...
						if (_v0.$ === 'Just') {
							...
							return _List_fromArray(
								[
									$author$project$Main$viewPauseOverlayHtml(overlay)
								]);
						} else {
							return _List_Nil;
						}
					...
					function () {
						if (showWinnerOverlay && config.showWinnerOverlay) {
							if (winnerName.$ === 'Just') {
								var name = winnerName.a;
								return _List_fromArray(
									[
										A3($author$project$Main$viewWinnerOverlayHtml, config.isCompactLayout, name, config.newRoundAction)
									]);
							} else {
								return _List_Nil;
							}
...
var $author$project$Main$viewReplayHtml = F2(
	function (replayIndex, moveCount) {
		var isLive = _Utils_eq(replayIndex, $elm$core$Maybe$Nothing);
		var currentIndex = A2($elm$core$Maybe$withDefault, moveCount, replayIndex);
		var label = (!moveCount) ? 'Replay appears once moves are made.' : ('Move ' + ($elm$core$String$fromInt(currentIndex) + (' of ' + ($elm$core$String$fromInt(moveCount) + (isLive ? ' - live board' : '')))));
		var replayProgress = (moveCount <= 0) ? '0%' : ($elm$core$String$fromFloat((currentIndex / moveCount) * 100) + '%');
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('board-replay replay')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('replay-controls')
						]),
					_List_fromArray(
						[
							A4(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('replay-progress'),
							A2($elm$html$Html$Attributes$attribute, 'aria-hidden', 'true')
						]),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('replay-progress-fill'),
									A2($elm$html$Html$Attributes$style, 'width', replayProgress)
								]),
							_List_Nil)
						])),
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$id('replayText')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(label)
...
var $author$project$Main$viewRoundSummaryHtml = F4(
	function (winnerName, blueScore, redScore, onNewRound) {
		return A2(
			$elm$html$Html$section,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('elm-round-result')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('elm-match-summary-kicker')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Round complete')
						])),
					A2(
					$elm$html$Html$h3,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(winnerName + ' wins this round')
						])),
					A2(
					$elm$html$Html$p,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('elm-match-meta')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Score: Blue ' + ($elm$core$String$fromInt(blueScore) + (' - Red ' + $elm$core$String$fromInt(redScore))))
						])),
					A4($author$project$Main$viewGhostButtonHtml, 'elm-match-continue', true, onNewRound, 'Continue / New Round')
				]));
	});
var $author$project$Main$shareIconSvg = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
			...
			$elm$svg$Svg$Attributes$strokeWidth('2.2'),
			$elm$svg$Svg$Attributes$strokeLinecap('round'),
			$elm$svg$Svg$Attributes$strokeLinejoin('round'),
			A2($elm$html$Html$Attributes$attribute, 'aria-hidden', 'true'),
...
var $author$project$Main$viewShareIconButtonHtml = F3(
	function (className, onPress, ariaLabel) {
		return A2(
			$elm$html$Html$button,
			_Utils_ap(
				_List_fromArray(
				...
				$author$project$Main$onClickAttributes(onPress)),
			_List_fromArray(
				[$author$project$Main$shareIconSvg]));
	});
var $author$project$Main$viewSquareIconButtonHtml = F4(
	function (className, onPress, icon, ariaLabel) {
		return A2(
			$elm$html$Html$button,
			_Utils_ap(
				_List_fromArray(
...
var $author$project$Main$viewTimerPillHtml = F2(
	function (timerSecs, timerRemainingSecs) {
		if (timerSecs.$ === 'Just') {
			var secs = timerSecs.a;
			return A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('elm-timer-display')
					]),
				A2(
					$elm$core$List$cons,
					$elm$html$Html$text(
						'Timer: ' + ($elm$core$String$fromInt(secs) + 's')),
					function () {
						if (timerRemainingSecs.$ === 'Just') {
							var remainingSecs = timerRemainingSecs.a;
							return _List_fromArray(
								[
									A2(
									$elm$html$Html$span,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('elm-timer-countdown')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(
											$elm$core$String$fromInt(remainingSecs) + 's left')
										]))
								]);
						} else {
							return _List_Nil;
...
var $author$project$Main$viewDesktopBoardScreenHtml = function (config) {
	var session = config.board.currentSession;
	var round = A2(
		$elm$core$Maybe$andThen,
		function ($) {
			return $.round;
		...
		session);
	var winnerName = config.showWinnerOverlay ? A2(
		$elm$core$Maybe$map,
		$author$project$Main$winnerDisplayName(config.board),
		A2(
			$elm$core$Maybe$andThen,
			function ($) {
				return $.winner;
	...
	var blueName = A2(
		...
		A2(
			...
			config.board.blue.player));
	return A2(
		$elm$html$Html$section,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('game-layout')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('board-card mobile-page active'),
						A2($elm$html$Html$Attributes$attribute, 'data-mobile-page', 'play')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('playStatus'),
								$elm$html$Html$Attributes$class('play-status')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(config.statusText)
							])),
						A2($author$project$Main$viewTimerPillHtml, config.timerSecs, config.timerRemainingSecs),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2('turn-indicator', true),
										_Utils_Tuple2('red', config.turnIndicatorIsRed)
									]))
							]),
						_List_fromArray(
							[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('side mobile-page active'),
						A2($elm$html$Html$Attributes$attribute, 'data-mobile-page', 'match')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('card scoreboard elm-match-panel')
							]),
						_Utils_ap(
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('elm-match-heading')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('elm-match-heading-title')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text('Match')
												])),
											A3($author$project$Main$viewShareIconButtonHtml, 'elm-match-icon share elm-match-share-corner', config.shareAction, 'Share board')
										])),
									A2(
									$elm$html$Html$p,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('elm-match-subtitle')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(config.matchSubtitle)
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
									...
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('players score-strip'),
											A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Room score')
										]),
									_List_fromArray(
										[
											A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('score-name blue-name')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class('dot blue')
														]),
													_List_Nil),
													A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('score-spacer'),
													A2($elm$html$Html$Attributes$attribute, 'aria-hidden', 'true')
												]),
											_List_Nil),
											A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('score-name red-name')
												]),
											_List_fromArray(
												[
													A2(
													...
													_List_fromArray(
														[
															$elm$html$Html$text(redName)
														])),
													A2(
													$elm$html$Html$span,
													_List_fromArray(
														[
															$elm$html$Html$Attributes$class('dot red')
														]),
													_List_Nil)
												])),
											A2(
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('score-number blue-score')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text(
													$elm$core$String$fromInt(blueScore))
												])),
											A2(
											$elm$html$Html$div,
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('score-dash')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text('-')
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$class('score-number red-score')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text(
													$elm$core$String$fromInt(redScore))
												]))
										])),
									A2(
									$elm$html$Html$div,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$class('elm-match-actions')
										]),
									_List_fromArray(
										[
											A4($author$project$Main$viewSquareIconButtonHtml, 'elm-match-icon danger', config.leaveAction, '✕', 'Leave game'),
											A4(
											$author$project$Main$viewSquareIconButtonHtml,
											'elm-match-icon',
											config.pauseAction,
											config.isPaused ? '▶' : '⏸',
											'Pause game'),
											A4($author$project$Main$viewSquareIconButtonHtml, 'elm-match-icon success', config.newRoundAction, '↺', 'Start new round')
										]))
								]),
							_Utils_ap(
								function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$width(1),
				$mdgriffith$elm_ui$Element$Border$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 110, 130, 112)),
				$mdgriffith$elm_ui$Element$Background$color(
				A4($mdgriffith$elm_ui$Element$rgba255, 2, 29, 10, 214)),
				$mdgriffith$elm_ui$Element$Font$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 244, 255, 246)),
				$mdgriffith$elm_ui$Element$Font$size(13)
			]),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Border$width(1),
					$mdgriffith$elm_ui$Element$Border$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 70, 92, 74)),
					$mdgriffith$elm_ui$Element$Background$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 28, 54, 31)),
					$mdgriffith$elm_ui$Element$Font$color(
					enabled ? A3($mdgriffith$elm_ui$Element$rgb255, 244, 255, 246) : A4($mdgriffith$elm_ui$Element$rgba255, 255, 255, 255, 120)),
					$mdgriffith$elm_ui$Element$Font$size(16),
					$mdgriffith$elm_ui$Element$Font$bold,
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$attribute, 'aria-label', label))
				]),
			{
				...
				onPress: enabled ? onPress : $elm$core$Maybe$Nothing
			});
	});
var $author$project$Main$viewMobileReplayCard = F2(
	function (replayIndex, moveCount) {
		var currentIndex = A2($elm$core$Maybe$withDefault, moveCount, replayIndex);
		var label = (!moveCount) ? 'Replay appears once moves are made.' : ('Move ' + ($elm$core$String$fromInt(currentIndex) + (' of ' + ($elm$core$String$fromInt(moveCount) + (_Utils_eq(replayIndex, $elm$core$Maybe$Nothing) ? ' - live board' : '')))));
		var progress = (moveCount <= 0) ? 0 : $elm$core$Basics$round((currentIndex / moveCount) * 100);
		return $author$project$Main$mobileCard(
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$el,
					...
					$mdgriffith$elm_ui$Element$text('Replay')),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							A4(
							$author$project$Main$viewMobileReplayButton,
							moveCount > 0,
							$elm$core$Maybe$Just($author$project$Main$ReplayToStart),
							'⏮',
							'Start'),
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Background$color(
							A4($mdgriffith$elm_ui$Element$rgba255, 255, 255, 255, 28)),
							$mdgriffith$elm_ui$Element$clip
						]),
					A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$width(
								$mdgriffith$elm_ui$Element$fillPortion(progress)),
								$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
								$mdgriffith$elm_ui$Element$Border$rounded(999),
								$mdgriffith$elm_ui$Element$Background$color(
								A3($mdgriffith$elm_ui$Element$rgb255, 24, 221, 79))
							]),
						$mdgriffith$elm_ui$Element$none)),
					A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Font$size(13),
							$mdgriffith$elm_ui$Element$Font$color(
							A3($mdgriffith$elm_ui$Element$rgb255, 200, 220, 200)),
							$mdgriffith$elm_ui$Element$Font$bold
						]),
					_List_fromArray(
						[
...
var $author$project$Main$viewMobileActionButton = F4(
	function (isDanger, msg, icon, label) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Border$width(1),
					$mdgriffith$elm_ui$Element$Border$color(
					isDanger ? A3($mdgriffith$elm_ui$Element$rgb255, 219, 80, 73) : A3($mdgriffith$elm_ui$Element$rgb255, 70, 92, 74)),
					$mdgriffith$elm_ui$Element$Background$color(
					isDanger ? A3($mdgriffith$elm_ui$Element$rgb255, 86, 24, 20) : A3($mdgriffith$elm_ui$Element$rgb255, 28, 54, 31)),
					$mdgriffith$elm_ui$Element$Font$color(
...
var $author$project$Main$viewMobilePrimaryActionButton = F3(
	function (msg, icon, label) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Border$rounded(16),
					$mdgriffith$elm_ui$Element$Background$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 246, 185, 43)),
					$mdgriffith$elm_ui$Element$Font$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 50, 29, 0)),
					$mdgriffith$elm_ui$Element$Font$bold,
					$mdgriffith$elm_ui$Element$Font$size(16),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2($elm$html$Html$Attributes$attribute, 'aria-label', label))
...
var $author$project$Main$viewMobileEllipsisText = F3(
	function (alignEnd, size, label) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$bold,
					$mdgriffith$elm_ui$Element$Font$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 232, 245, 236)),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					A2(
						$elm$html$Html$Attributes$style,
						'text-align',
...
var $author$project$Main$viewMobileScorePill = F3(
	function (color, name, score) {
		var scoreRow = (color === 'blue') ? A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
		...
		var nameRow = (color === 'blue') ? A2(
			...
			_List_fromArray(
				[
					...
					A3($author$project$Main$viewMobileEllipsisText, true, 12, name)),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$size(12),
							$mdgriffith$elm_ui$Element$Font$color(
							A3($mdgriffith$elm_ui$Element$rgb255, 11, 124, 255))
						]),
					$mdgriffith$elm_ui$Element$text('●'))
				])) : A2(
			$mdgriffith$elm_ui$Element$row,
				...
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$size(12),
							$mdgriffith$elm_ui$Element$Font$color(
							A3($mdgriffith$elm_ui$Element$rgb255, 255, 59, 48))
						]),
					$mdgriffith$elm_ui$Element$text('●')),
					A2(
					$mdgriffith$elm_ui$Element$el,
					...
					A3($author$project$Main$viewMobileEllipsisText, false, 12, name))
				]));
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$spacing(4),
					A2($mdgriffith$elm_ui$Element$paddingXY, 10, 9),
					$mdgriffith$elm_ui$Element$Border$rounded(18),
					$mdgriffith$elm_ui$Element$Background$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 15, 42, 22)),
					$mdgriffith$elm_ui$Element$Border$width(1),
					$mdgriffith$elm_ui$Element$Border$color(
					(color === 'blue') ? A3($mdgriffith$elm_ui$Element$rgb255, 34, 90, 160) : A3($mdgriffith$elm_ui$Element$rgb255, 142, 49, 45)),
					$mdgriffith$elm_ui$Element$clip
				]),
			_List_fromArray(
				[nameRow, scoreRow]));
	});
var $author$project$Main$viewMobileTimerChip = F2(
	function (timerSecs, timerRemainingSecs) {
		if (timerSecs.$ === 'Just') {
			var secs = timerSecs.a;
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Border$rounded(999),
						$mdgriffith$elm_ui$Element$Background$color(
						A4($mdgriffith$elm_ui$Element$rgba255, 0, 0, 0, 150)),
						$mdgriffith$elm_ui$Element$Border$width(1),
						$mdgriffith$elm_ui$Element$Border$color(
						A4($mdgriffith$elm_ui$Element$rgba255, 255, 255, 255, 20)),
						$mdgriffith$elm_ui$Element$Font$color(
						A3($mdgriffith$elm_ui$Element$rgb255, 240, 255, 244)),
						$mdgriffith$elm_ui$Element$Font$size(12),
						$mdgriffith$elm_ui$Element$Font$bold
					]),
				A2(
...
var $author$project$Main$viewShareMobileButton = function (shareMsg) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
				...
				A3($mdgriffith$elm_ui$Element$rgb255, 98, 232, 248)),
				$mdgriffith$elm_ui$Element$Background$color(
				A4($mdgriffith$elm_ui$Element$rgba255, 11, 124, 255, 36)),
				$mdgriffith$elm_ui$Element$Font$color(
				A3($mdgriffith$elm_ui$Element$rgb255, 232, 251, 255)),
				$mdgriffith$elm_ui$Element$Font$size(16),
				$mdgriffith$elm_ui$Element$Font$bold,
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Share'))
			]),
		{
			label: A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
				$mdgriffith$elm_ui$Element$html($author$project$Main$shareIconSvg)),
			onPress: $elm$core$Maybe$Just(shareMsg)
		});
};
...
var $author$project$Main$viewMobileTopCard = F6(
	function (config, statusBanner, blueName, redName, blueScore, redScore) {
		return (!_Utils_eq(config.newRoundAction, $elm$core$Maybe$Nothing)) ? $author$project$Main$mobileCard(
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$row,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$Font$color(
									A4($mdgriffith$elm_ui$Element$rgba255, 255, 255, 255, 170)),
									$mdgriffith$elm_ui$Element$Font$size(11),
									$mdgriffith$elm_ui$Element$Font$semiBold
								]),
							$mdgriffith$elm_ui$Element$text(config.matchSubtitle)),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
							...
							$mdgriffith$elm_ui$Element$text('ROUND COMPLETE'))
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					_List_fromArray(
						[
							A3($author$project$Main$viewMobileScorePill, 'blue', blueName, blueScore),
							A3($author$project$Main$viewMobileScorePill, 'red', redName, redScore)
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$elm$core$Maybe$map,
								function (msg) {
									return A3($author$project$Main$viewMobilePrimaryActionButton, msg, '▶', 'Continue');
								},
								config.newRoundAction),
								A2(
								$elm$core$Maybe$map,
								function (msg) {
				...
				])) : $author$project$Main$mobileCard(
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$row,
					...
					_List_fromArray(
						[
							A2($author$project$Main$viewMobileTimerChip, config.timerSecs, config.timerRemainingSecs),
							A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Border$rounded(18),
							$mdgriffith$elm_ui$Element$Background$color(
							config.turnIndicatorIsRed ? A3($mdgriffith$elm_ui$Element$rgb255, 83, 29, 26) : A3($mdgriffith$elm_ui$Element$rgb255, 17, 54, 76)),
							$mdgriffith$elm_ui$Element$Border$width(1),
							$mdgriffith$elm_ui$Element$Border$color(
							A3($mdgriffith$elm_ui$Element$rgb255, 76, 106, 118)),
							$mdgriffith$elm_ui$Element$Font$color(
							A3($mdgriffith$elm_ui$Element$rgb255, 245, 249, 244)),
							$mdgriffith$elm_ui$Element$Font$size(15),
							$mdgriffith$elm_ui$Element$Font$bold
						]),
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(statusBanner)
							]))),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$elm$core$Maybe$map,
								function (msg) {
									return $author$project$Main$viewShareMobileButton(msg);
								},
								config.shareAction),
								A2(
								$elm$core$Maybe$map,
...
var $author$project$Main$viewMobileBoardScreen = function (config) {
	...
	var statusBanner = function () {
		if (winnerName.$ === 'Just') {
			...
			return config.turnIndicatorText;
		}
	}();
	var redScore = A2(
		$elm$core$Maybe$withDefault,
	...
	return A2(
		...
		_List_fromArray(
			[
				A6($author$project$Main$viewMobileTopCard, config, statusBanner, blueName, redName, blueScore, redScore),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$html(
					A7($author$project$Main$viewBoardStageHtml, true, config, blueName, redName, blueScore, redScore, winnerName))),
				A2($author$project$Main$viewMobileReplayCard, config.replayIndex, config.moveCount)
			]));
};
var $author$project$Main$viewBoardScreenHtml = function (config) {
	return config.isCompactLayout ? A2(
		...
		return $author$project$Main$viewBoardScreenHtml(
			{
				...
				moveCount: $elm$core$List$length(lg.moves),
				newRoundAction: (!_Utils_eq(winnerName, $elm$core$Maybe$Nothing)) ? $elm$core$Maybe$Just($author$project$Main$LocalNewRound) : $elm$core$Maybe$Nothing,
				ownSeat: $elm$core$Maybe$Just(lg.turn),
...
var $author$project$Main$SetMainTab = function (a) {
	return {$: 'SetMainTab', a: a};
};
var $author$project$Main$viewMainTabs = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				'Setup',
				model.mainTab === 'game',
				$author$project$Main$SetMainTab('game')),
				A3(
				$author$project$Main$gradientTabButton,
				'Boards',
				model.mainTab === 'boards',
				$author$project$Main$SetMainTab('boards'))
			]));
};
var $author$project$Main$viewMobileGameHeader = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			...
			$mdgriffith$elm_ui$Element$Border$width(1),
			$mdgriffith$elm_ui$Element$Border$color(
			A4($mdgriffith$elm_ui$Element$rgba255, 115, 176, 132, 60)),
			$mdgriffith$elm_ui$Element$Background$color(
			A4($mdgriffith$elm_ui$Element$rgba255, 1, 22, 8, 240)),
			$mdgriffith$elm_ui$Element$Font$color(
			A3($mdgriffith$elm_ui$Element$rgb255, 244, 255, 246))
		]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Border$width(1),
					$mdgriffith$elm_ui$Element$Border$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 64, 88, 69)),
					$mdgriffith$elm_ui$Element$Background$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 10, 36, 18)),
				...
				label: A2(
					...
					_List_fromArray(
						[
							...
							A3($mdgriffith$elm_ui$Element$rgb255, 244, 255, 246)),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$attribute, 'aria-label', 'Open lobby'))
						]),
					$mdgriffith$elm_ui$Element$text('←')),
				onPress: $elm$core$Maybe$Just($author$project$Main$ToggleLobby)
			}),
			...
			$mdgriffith$elm_ui$Element$text('Game')),
			A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
		...
		[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$size(13),
					$mdgriffith$elm_ui$Element$Font$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 210, 230, 212)),
					$mdgriffith$elm_ui$Element$Font$semiBold
				]),
			$mdgriffith$elm_ui$Element$text('Game in progress')),
			A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Border$rounded(14),
					$mdgriffith$elm_ui$Element$Background$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 33, 194, 216)),
					$mdgriffith$elm_ui$Element$Border$width(1),
					$mdgriffith$elm_ui$Element$Border$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 98, 232, 248)),
					$mdgriffith$elm_ui$Element$Font$color(
					A3($mdgriffith$elm_ui$Element$rgb255, 6, 22, 10)),
					$mdgriffith$elm_ui$Element$Font$bold,
					$mdgriffith$elm_ui$Element$Font$size(13)
				]),
			{
				label: $mdgriffith$elm_ui$Element$text('Open Game'),
				onPress: $elm$core$Maybe$Just($author$project$Main$ToggleLobby)
			})
		]));
var $author$project$Main$viewMobileApp = F4(
	function (model, hasGame, lobbyLayout, gameView) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					(hasGame && (!model.showLobby)) ? $author$project$Main$viewMobileGameHeader : $author$project$Main$viewMobileLobbyHeader,
					(hasGame && (!model.showLobby)) ? gameView : A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					...
					_List_fromArray(
						[
							hasGame ? $author$project$Main$viewMobileOpenGameStrip : $mdgriffith$elm_ui$Element$none,
							lobbyLayout
						]))
				]));
	});
...
var $author$project$Main$seatMatchesTurn = F2(
	function (ownSeat, turn) {
		if (ownSeat.$ === 'Just') {
			...
			return _Utils_eq(
				$author$project$Main$normalizeSeatId(seatId),
				$author$project$Main$normalizeSeatId(turn));
		} else {
			return false;
		}
	});
var $author$project$Main$onlineStatusText = F4(
	function (board, ownSeat, turn, winnerName) {
		if (winnerName.$ === 'Just') {
			var name = winnerName.a;
			return name + (' wins. ' + A2(
				$elm$core$Maybe$withDefault,
...
var $author$project$Main$onlineTurnIndicatorText = F3(
	function (board, turn, winnerName) {
		if (winnerName.$ === 'Just') {
			var name = winnerName.a;
			return name + ' wins the round';
		} else {
			return $elm$core$String$isEmpty(turn) ? $author$project$Main$waitingStatusTextForBoard(board) : ($author$project$Main$turnColorLabel(turn) + ' to move');
		}
	});
var $author$project$Main$viewOnlineGameHtml = F2(
	function (model, board) {
		var round = A2(
			$elm$core$Maybe$andThen,
			function ($) {
		...
		var winnerName = A2(
			$author$project$Main$replayShowsWinner,
			model.replayIndex,
			$author$project$Main$currentMoveCount(model)) ? A2(
			$elm$core$Maybe$map,
			$author$project$Main$winnerDisplayName(board),
			A2(
				$elm$core$Maybe$andThen,
		...
		return $author$project$Main$viewBoardScreenHtml(
			{
				...
				leaveAction: A2(
					$elm$core$Maybe$map,
					function (_v0) {
						return $author$project$Main$LeaveSeat;
					},
					ownSeat),
...
var $author$project$Main$viewApp = function (model) {
	var lobbyLayout = A2(
		...
		_List_fromArray(
			[
				...
				A2($mdgriffith$elm_ui$Element$paddingXY, 10, 8),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				$elm$html$Html$Attributes$class('lobby-layout')),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2($elm$html$Html$Attributes$attribute, 'data-lobby-active-tab', model.mainTab))
			]),
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$author$project$Main$viewMainTabs(model),
	...
	return isMobile ? A4($author$project$Main$viewMobileApp, model, hasGame, lobbyLayout, gameView) : A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
		...
		_List_fromArray(
			[
				hasGame ? $author$project$Main$viewGameHeader(model) : A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
				...
				$mdgriffith$elm_ui$Element$html(
					A2($author$project$Main$viewHeaderHtml, model, false))),
				hasGame ? A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($elm$html$Html$Attributes$style, 'background', backgroundColor),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$author$project$Main$moveTimerLabel(optionSeconds))
						])),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$style,
							'color',
							isSelected ? 'rgb(23, 210, 230)' : 'rgba(255,255,255,0.34)')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$attribute,
				'data-elm-mode',
				hasGame ? 'playing' : 'lobby'),
				A2(
				$elm$html$Html$Attributes$attribute,
				'data-elm-lobby-open',
				model.showLobby ? 'true' : 'false')
			]),
		_List_fromArray(
			[
				A2(
